...
/*
    ...
    >> Spring Data JPA Auditing - 기록에 대한 처리
        : @EnableJpaAuditing 활성화
        : 공통부모 클래스 BasTimeEntity에 @CreateDate, @LastModifiedDate 사용
    ...
    cf) Gradle 의존성 추가
        ...
        > MySQL 드라이버
        > Java 8 날짜/시간 직렬화
            : Java 객체를 JSON 데이터로 변환(직렬화)하거나, JSON 데이터를 Java 객체로 변환(역직렬화)하는데 사용
