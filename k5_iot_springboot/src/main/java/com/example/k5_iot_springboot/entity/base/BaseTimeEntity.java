 ...
 * - 필드는 LocalDateTime 사용, DB는 DATETIME(6) 으로 지정(타임존 정보 없음)
 * - UTC 기준으로 저장되도록애플리케이션 기본 타임존은 UTC로 고정(TimeConfig)
 */
@Getter
@MappedSuperclass // 실제 테이블을 만들지 않고, 필드를 자식 엔티티 컬럼에 포함 시킴
